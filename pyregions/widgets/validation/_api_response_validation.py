...
class ValidateApiResponse(CoreValidation):
	...
	def __init__(self, response:Dict[str,Union[str,Dict]]):
		self.required_primary_keys:List[str] =['report', 'agency', 'regions']
		self.required_report_keys:List[str] = ['reportName', 'reportCode', 'reportDate', 'reportUrl']
		self.required_region_keys:List[str] = ['regionName', 'regionCode', 'regionType', 'regionSeries']
		self.required_agency_keys:List[str] = ['agencyName', 'agencyCode', 'agencyAddress', 'agencyUrl']
		self.required_series_keys:List[str] = [
		...
		report_arguments:Dict = response['report']
		...
		#print("Successfully validated the API response.")
