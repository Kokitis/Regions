...
class CoreValidation:
	...
	@staticmethod
	def _validateString(string: str, optional: bool = False) -> bool:
	...
	@staticmethod
	def _validateNumber(value: Number, optional: bool = False, number_type = 'any') -> bool:
		if number_type == 'any':
			dtypes = (float, int)
	...
	@staticmethod
	def validateKeys(entity_type: str, expected_keys: Iterable[str], keys: Iterable[str]) -> None:
	...
	@staticmethod
	def showError(entity_type: str, raw_parameters: Dict, validation_status: Dict) -> None:
		"""
